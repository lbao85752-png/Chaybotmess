...
local v16 = {
    ...
    Sea = v15:AddTab({
        Title = "Tab Núi Lửa Và Sự Kiện Biển"
    }),
    ITM = v15:AddTab({
        Title = "Tab Farm Khác"
    }),
    ...
    Status = v15:AddTab({
        Title = "Tab Trạng thái và máy chủ"
    }),
    Stats = v15:AddTab({
        Title = "Tab Thống kê"
    }),
    ...
    Fruit = v15:AddTab({
        Title = "Tab Esp Và Trái Cây"
    }),
    Raid = v15:AddTab({
        Title = "Tab Raid"
    }),
    Race = v15:AddTab({
        Title = "Tab Nâng cấp chủng tộc"
    }),
    Shop = v15:AddTab({
        Title = "Tab Cửa Hàng"
    }),
...
v23.Draggable = true;
v23.Image = "http://www.roblox.com/asset/?id=76338007379791";
...
v16.Home:AddButton({
    Title = "Remember:",
    Description = "This is not the real Banana Cat Hub, but a fake version made by LGB Roblox.",
    Callback = function()
        setclipboard("https://www.tiktok.com/@hnc_roblox?_t=ZS-8ywjDgNQ1ah&_r=1");
    end
});
